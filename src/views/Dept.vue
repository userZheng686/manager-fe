<template>
    <div class="dept-manage">
        ...
        <div class="base-table">
            ...
            <el-table v-loading="deptList.length === 0" :data="deptList" row-key="_id" :tree-props="{children}" stripe>
                <el-table-column
        ...
        <el-dialog :title="action === 'create' ? '创建部门' : '编辑部门'" v-model="showModal">
            <el-form ref="dialogForm" :model="deptForm" :rules="rules" label-width="120px">
                ...
                <el-form-item label="负责人" prop="user">
                    <el-select placeholder="请输入部门负责人" v-model="deptForm.user" @change="handleUser">
